...
| **SUFIA-BC**       | ORBIT-Surgical   | Generating high-quality demonstration data for visuomotor policy learning in surgical subtasks | -    | -    |
...
| Platform                                 | Base Framework       | Key Features                                                                                                      | Link | Code |
| ---------------------------------------- | -------------------- | ----------------------------------------------------------------------------------------------------------------- | ---- | ---- |
| **Low-Fidelity VR Laparoscopic Trainer** | Unity + Meta Quest 2 | Cost-effective VR training for peg transfer tasks with AI-powered assessment (YOLOv8-based automated evaluation)  | -    | -    |
| **Learning Spatial Awareness System**    | Unity + Isaac Sim    | Dual visual training framework combining 2D endoscopic view with 3D MR feedback for laparoscopic surgery training | -    | -    |
